...
d3.json('first.json',function(error,data)
{
	...
	yScale.domain([0,d3.max(data,function(d){return d["Purchasing Power in Billions ( Current International Dollar) - 2013"];})]).nice();
		...
		.style("fill",function(d,i){return 'rgb(20,'+((i*20) +100)+',20)'});
